...
contract Escrow {
    ...
    // => if inspection status is not approved, then refurnd, otherwise send to seller
    ...
    function finalizeSale() public {
        ...
        require(address(this).balance >= purchasePrice, 'musy have enough ether for sale');
